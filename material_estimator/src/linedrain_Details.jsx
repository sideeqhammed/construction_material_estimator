...
function LinedrainDetails() {
  ...
  const results = useMemo(() => {
    ...
    const baseLength = breadth + thickness + thickness;
    const baseArea = baseLength * thickness;
    const wallArea = 2 * (height * thickness);
    const voulume = length * (baseArea + wallArea);
  ...
  return (
    <div className="m-5 mt-10 mx-auto bg-gray-100 p-10 max-w-7xl">
      <h2 className="text-2xl font-bold pb-8 text-center">Line Drains</h2>
...
export default LinedrainDetails;
